...
VEHICLE.Title 		= "1998 Ford Crown Victoria MSP Slicktop"
		...
		Options = {
			{
				Option = "Patrol",
				SubMaterials = {
					{ Id = 3, Material = "rin/msp/crownvic98/patrol_slick" }
				},
			},
			{
				Option = "K-9 Unit",
				SubMaterials = {
					{ Id = 3, Material = "rin/msp/crownvic98/k9_slick" }
				},
			},
			{
				Option = "Supervisor",
				SubMaterials = {
					{ Id = 3, Material = "rin/msp/crownvic98/supervisor_slick" }
				},
			},
			{
				Option = "Port Authority",
				SubMaterials = {
					{ Id = 3, Material = "rin/msp/crownvic98/massport_slick" }
				},
			},
			{
				Option = "Turnpike Patrol",
				SubMaterials = {
					{ Id = 3, Material = "rin/msp/crownvic98/masspike_slick" }
				},
			},
		}
	},
		...
		Options = {
			{
				...
				Components = {
					{
						Component = "photon_generic_flasher_mass",
						Position = Vector( 12.5, 13, 59 ),
						Angles = Angle( 182, 0, 0 ),
						Scale = 0.7,
						Phase = 180,
						SubMaterials = {
							[3] = "sentry/props/koitoflasher/glass_blue",
