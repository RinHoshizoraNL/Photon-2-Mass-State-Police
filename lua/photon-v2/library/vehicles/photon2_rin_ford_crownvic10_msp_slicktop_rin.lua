...
VEHICLE.Title 		= "2010 Ford Crown Victoria MSP Slicktop"
				...
				Components = {
					{
						...
						Position = Vector( -45.8, 25.1, 47.5 ),
						Angles = Angle( 0, 25.5, -2 ),
						Scale = 0.7,
					},
                    {
						Component = "photon_whe_ion_surface_mass",
		...
		Options = {
			{
				...
				Props = {
					...
					},
					{
						...
						Position = Vector( 0, -57, 66.1),
						Angles = Angle( 0, 0, 8.7 ),
						Scale = 1,
					},
					{
						Model = "models/schmal/antenna_pod_trimode.mdl",
						Position = Vector( 0, -40, 67.4),
