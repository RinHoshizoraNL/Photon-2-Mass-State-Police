...
COMPONENT.Title = [[Code 3 MX7000 MSP]]
...
COMPONENT.SubMaterials = {
	[0] = "rin/msp/props/mx7000_glass_colored",
	[1] = "rin/msp/props/mx7000_glass_outer",
	[2] = "rin/msp/props/mx7k",
	[3] = "rin/msp/props/glass_mx7000",
...
COMPONENT.StateMap = "[ROT] 1 2 3 4 5 [~SW] 33 34 47 48 [~R] 29 [~A] 30 [~B] 54 55 56 19 20 15 16 17 18 13 14 11 12 6 8 10 22 24 36 38 40 42 44 46 7 9 21 23 25 35 37 39 41 43 45 26 27 28 31 32 [ProxyC] 53 [ProxyLI] 51 [ProxyRI] 52 [ProxyLO] 49 [ProxyRO] 50"

local fov = 180

COMPONENT.Elements = {
	[1] = { "Rotator", BoneId = 2, Axis = "z", Speed = 700, AngleOutputMap = { { 0, "~B" }, { 45, "OFF" }, { 135, "~B" }, { 225, "OFF" }, { 315, "~B" } } },
	[2] = { "Rotator", BoneId = 3, Axis = "z", Speed = 710, AngleOutputMap = { { 0, "~B" }, { 45, "OFF" }, { 135, "~B" }, { 225, "OFF" }, { 315, "~B" } } },
	[3] = { "Rotator", BoneId = 4, Axis = "z", Speed = 440, AngleOutputMap = { { 0, "~B" }, { 225, "OFF" }, { 315, "~B" } } },
