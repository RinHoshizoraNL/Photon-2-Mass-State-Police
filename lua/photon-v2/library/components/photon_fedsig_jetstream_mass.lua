...
COMPONENT.PrintName = [[Federal Signal Jetstream MSP]]
...
COMPONENT.StateMap = "[~B] 1 2 3 4 5 6 12 13 15 16 17 18 19 20 21 [~SW] 14 22 23 [ROT] 7 8 10 11 [Sweep] 9"
...
COMPONENT.Elements = {
	...
	[7] = { "Rotator", BoneId = 2, Axis = "z", Speed = -360 },
	[8] = { "Rotator", BoneId = 3, Axis = "z", Speed = -900 },
	[9] = { "Rotator", BoneId = 5, Axis = "z", Speed = -216 },
	[10] = { "Rotator", BoneId = 4, Axis = "z", Speed = -895 },
	[11] = { "Rotator", BoneId = 1, Axis = "z", Speed = -357.5 },
